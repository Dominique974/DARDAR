...
class Matching:
    def __init__(self,configFile, mySaison):
    ...
    def valid_preselection(self):
        ...
        cursor.execute("SELECT transect, saison, num_depr, distance FROM transect_besttrack_matching_1000km_from_3H where saison = " + str(self.mySaison))
...
if __name__ == "__main__":
     ...
     mySaison = sys.argv[2]
     myMatching = Matching(configFile, mySaison)
